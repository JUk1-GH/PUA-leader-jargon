---
agent: 'agent'
description: "Standalone automatic PUA Skill, leader-jargon edition. Derived from tanweai/pua. Uses Chinese management phrases to force exhaustive problem-solving, concrete execution, and verified delivery."
---
