...
> 大部分人以为这个项目是在写领导黑话，其实这是最大的误解。让你的 Codex / Claude Code 不再空转，把任务做成闭环。

一个 AI Coding Agent 技能插件，用领导高深 PUA 话术驱动 AI 穷尽所有方案才允许放弃。支持 **Claude Code**、**OpenAI Codex CLI**、**pi coding agent**、**Trae**、**Cursor**、**Kiro**、**CodeBuddy**、**OpenClaw**、**Google Antigravity**、**OpenCode** 和 **VSCode (GitHub Copilot)**。三重能力：

1. **领导高深话术** — 让 AI 不敢放弃
2. **闭环调试方法论** — 让 AI 有能力不放弃
