...
inclusion: auto
name: pua-en
description: "Standalone automatic PUA Skill, leader-jargon edition. Derived from tanweai/pua. Uses Chinese management phrases such as 顶层设计, 颗粒度, 抓手, 底层逻辑, 闭环销项 to force exhaustive problem-solving, concrete execution, and verified delivery. This edition exposes only the leader-jargon mode."
---
